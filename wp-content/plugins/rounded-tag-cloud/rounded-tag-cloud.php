...
class rounded_tag_cloud {
   ...
   function widget($args) {
      ...
      if ($options['link_to_us'] == 'checked') {
         echo '<div class="rtc-link"><a href="' . $this->_link . '" target="_blank" rel="nofollow">'. __('Get this widget for your own blog free!', $this->_folder) . '</a></div>';
      }
      echo '</div>';
      echo $after_widget;
   }
...
<?php 
    ...
    */
   function link($links) {
      $options_link = '<a href="' . $this->_link . '" rel="nofollow">' . __('Donate', $this->_folder) . '</a>';
