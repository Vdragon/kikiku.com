...
if (!function_exists('utf8_excerpt')) {
	function utf8_excerpt ($text, $type) {
		...
		if ( is_home() || is_category() || is_search() || is_archive()) {
...
if (!function_exists('utf8_excerpt_readmore')) {
	function utf8_excerpt_readmore ($text) {
		...
		//$text .= "<p class='read-more'><a class='more-link' href='".get_permalink()."'>".$read_more_link."</a></p>";
		$text .= "<p class='read-more'><a class='more-link' href='".get_permalink()."'>"." "."</a></p>";
		return $text;
	}
}
