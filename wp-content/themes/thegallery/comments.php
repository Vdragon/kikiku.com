...
<?php if ( have_comments() ) : ?>
	...
	<ol class="comment-list">
		<?php convert_smilies(wp_list_comments(array('callback' => 'get_comment_list'))); ?>
	</ol>
	<!-- Comment Navigation -->
...
<?php 
	...
	$comment_form = array( 
		...
		'comment_field' => '<div class="comment-form-comment">' . '123' . '<div style="float: left;">' . cs_print_smilies() . '</div>' . '123'.
