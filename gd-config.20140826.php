...
define( 'GD_MEMCACHE_SOCK',    'unix:///var/chroot/var/tmp/moxi/96c.756.myftpupload.com.sock' );
#define( 'GD_MEMCACHE_SOCK',    'localhost:11211' );
define( 'WP_CACHE_KEY_SALT',   'dyzytdbnx7t2bhtxnnhs' );
...
if ( function_exists( 'newrelic_set_appname' ) ) {
	newrelic_set_appname( '83f8a200-26f0-11e4-b747-f04da2077796;' . ini_get( 'newrelic.appname' ) );
}
